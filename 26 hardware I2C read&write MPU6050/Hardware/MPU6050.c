...
void MPU6050_WriteReg(uint8_t RegAddress,uint8_t DATA)
{
	...
	I2C_Send7bitAddress(I2C2,MPUU6050_ADDRESS,I2C_Direction_Transmitter);
...
uint8_t MPU6050_ReadReg(uint8_t RegAddress)
{
	...
	I2C_Send7bitAddress(I2C2,MPUU6050_ADDRESS,I2C_Direction_Receiver);
